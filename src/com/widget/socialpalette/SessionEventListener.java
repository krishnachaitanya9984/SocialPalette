...
public class SessionEventListener {
    ...
    private static LinkedList<AuthorizeListener> mAuthListeners = 
        new LinkedList<AuthorizeListener>();
     ...
     *            events happen.
     */
    public static void addAuthListener(AuthorizeListener listener) {
     ...
     *            events happen.
     */
    public static void removeAuthListener(AuthorizeListener listener) {
    ...
    public static void onLoginSuccess() {
        for (AuthorizeListener listener : mAuthListeners) {
