...
public class Facebook {
    ...
    private boolean startSingleSignOn(Activity activity, String applicationId,
        ...
        Log.d("startSingleSignOn","In Singlesignon");
        ...
        try {
        	Log.d("startSingleSignOn","start activity");
    ...
    public boolean isSessionValid() {
    		if(getAccessToken() != null) {
    			Log.d("isSessionValid","accesstoken is not null");
    		}else {
    			Log.d("isSessionValid","accesstoken is null");
    		}
